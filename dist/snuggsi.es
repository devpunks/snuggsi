...
/*
  ...
  Defines a routing rule to be applied.
  This is a markup equivalent of the 
  functional component `route`.

  Example:
  <template-route path='/' template='main'/>

*/

Element `template-route`
(class extends HTMLElement {
  initialize () {
    route(this.getAttribute('path'),
