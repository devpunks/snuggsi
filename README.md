...
<p align=center>
  <strong align=center>All you need is a browser and basic knowledge of <a href=https://developer.mozilla.org/en-US/docs/Web/HTML target=mdn>HTML</a>, CSS &amp; <a href=https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes target=mdn>Javascript classes</a> to be productive!</strong>
