...
* **Perform a [cursory search](https://github.com/snuggsi/issues)** to see if the problem has already been reported. If it has, add a comment to the existing issue instead of opening a new one.
